...
static int r_V(struct SN_env * z) {
    {
        ...
        {
            int v_2 = z->l - z->c;
            if (in_grouping_b(z, g_v, 97, 252, 0)) goto lab1;
            goto lab0;
        lab1:
            z->c = z->l - v_2;
            ...
            case 2:
                {
                    ...
                    {
                        int v_5 = z->l - z->c;
                        if (out_grouping_b(z, g_AEIOU, 97, 252, 0)) goto lab4;
                        goto lab3;
                    lab4:
                        z->c = z->l - v_5;
                        if (z->c > z->lb) goto lab0;
                ...
                lab3:
                    {
                        ...
                        {
                            int v_7 = z->l - z->c;
                            if (in_grouping_b(z, g_AIOU, 97, 252, 0)) goto lab7;
                            goto lab6;
                        lab7:
                            z->c = z->l - v_7;
                            if (in_grouping_b(z, g_E, 101, 235, 0)) goto lab5;
                    ...
                    }
                    {
                        ...
                        z->c--;
                        if (in_grouping_b(z, g_AIOU, 97, 252, 0)) goto lab8;
                        if (out_grouping_b(z, g_AEIOU, 97, 252, 0)) goto lab8;
                        goto lab0;
                    lab8:
                        z->c = z->l - v_8;
                    }
...
z->c = z->c + 3;
    ...
    }
    {
        int v_7 = z->c;
        z->bra = z->c;
        if (z->c >= z->l || (z->p[z->c + 0] != 235 && z->p[z->c + 0] != 239)) goto lab7;
...
z->c = z->c + 3;
    ...
    }
    {
        int v_7 = z->c;
        z->bra = z->c;
        if (z->c >= z->l || (z->p[z->c + 0] != 235 && z->p[z->c + 0] != 239)) goto lab8;
...
static int r_measure(struct SN_env * z) {
    ...
    z->I[0] = z->l;
    {
        ...
        z->I[1] = z->c;
        while (1) {
            if (out_grouping(z, g_v, 97, 252, 0)) goto lab5;
            continue;
        lab5:
            break;
        }
...
extern struct SN_env * dutch_ISO_8859_1_create_env(void) { return SN_create_env(1, 4); }

extern void dutch_ISO_8859_1_close_env(struct SN_env * z) { SN_close_env(z, 1); }
