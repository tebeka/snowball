...
static int r_not_after_letter(struct SN_env * z);
...
{ 1, s_9_1, 0, -1, 0},
{ 1, s_9_2, 0, -1, 0},
{ 1, s_9_3, 0, -1, r_not_after_letter},
{ 2, s_9_4, -1, -1, 0},
{ 2, s_9_5, -2, -1, 0},
{ 1, s_9_6, 0, -1, r_not_after_letter},
{ 2, s_9_7, -1, -1, 0},
{ 2, s_9_8, -2, -1, 0},
{ 2, s_9_9, -3, -1, r_not_after_letter},
{ 3, s_9_10, -1, -1, 0},
{ 3, s_9_11, -2, -1, 0},
{ 2, s_9_12, -6, -1, 0},
{ 1, s_9_13, 0, -1, 0},
...
static int r_final_apostrophe(struct SN_env * z) {
    ...
    lab2:
        z->c = z->l - v_1;
        if (z->c - 2 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((68438676 >> (z->p[z->c - 1] & 0x1f)) & 1)) goto lab3;
        if (!find_among_b(z, a_3, 20)) goto lab3;
        {
            int v_2 = z->l - z->c;
        ...
        lab5:
            z->c = z->l - v_2;
            if (z->c <= z->lb || z->p[z->c - 1] != '-') goto lab3;
            z->c--;
        }
    lab4:
        {
...
static int r_correlative(struct SN_env * z) {
    ...
    z->bra = z->c;
    {
        int v_1 = z->l - z->c;
        {
            ...
            {
                int v_3 = z->l - z->c;
                if (z->c <= z->lb || z->p[z->c - 1] != 'n') { z->c = z->l - v_3; goto lab2; }
                z->c--;
            lab2:
                ;
            }
        ...
        lab1:
            ...
            {
                int v_4 = z->l - z->c;
                if (z->c <= z->lb || z->p[z->c - 1] != 'n') { z->c = z->l - v_4; goto lab3; }
                z->c--;
            lab3:
                ;
            }
            {
                int v_5 = z->l - z->c;
                if (z->c <= z->lb || z->p[z->c - 1] != 'j') { z->c = z->l - v_5; goto lab4; }
                z->c--;
            lab4:
                ;
            }
    ...
    lab0:
        ...
        {
            int v_6 = z->l - z->c;
            if (!find_among_b(z, a_8, 7)) { z->c = z->l - v_6; goto lab5; }
        lab5:
            ;
        }
        {
...
static int r_not_after_letter(struct SN_env * z) {
    {
        int v_1 = z->l - z->c;
        if (z->c <= z->lb || z->p[z->c - 1] != '-') goto lab1;
        z->c--;
        goto lab0;
    lab1:
        z->c = z->l - v_1;
...
static int r_standard_suffix(struct SN_env * z) {
    ...
    {
        int v_1 = z->l - z->c;
        if (z->c <= z->lb || z->p[z->c - 1] != '-') { z->c = z->l - v_1; goto lab0; }
        z->c--;
    lab0:
        ;
    }
...
extern struct SN_env * esperanto_UTF_8_create_env(void) { return SN_create_env(0, 1); }

extern void esperanto_UTF_8_close_env(struct SN_env * z) { SN_close_env(z, 0); }
