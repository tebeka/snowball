    ...
    switch (among_var) {
            ...
            }
            {
                ...
                switch (among_var) {
                    case 1:
                        ...
                        z->ket = z->c;
                        if (!(eq_s_b(z, 2, s_18))) { z->c = z->l - v_3; goto lab3; }
                        z->bra = z->c;
                        {
                            int ret = r_R2(z);
                            if (ret == 0) { z->c = z->l - v_3; goto lab3; }
        ...
        case 8:
            ...
            }
            {
                int v_8 = z->l - z->c;
                z->ket = z->c;
                if (!(eq_s_b(z, 2, s_23))) { z->c = z->l - v_8; goto lab11; }
                z->bra = z->c;
                {
                    int ret = r_R2(z);
                ...
                z->ket = z->c;
                if (!(eq_s_b(z, 2, s_24))) { z->c = z->l - v_8; goto lab11; }
                z->bra = z->c;
                {
                    int v_9 = z->l - z->c;
                    {
        ...
        int v_3 = z->l - z->c;
        {
            ...
            lab3:
                z->c = z->l - v_5;
                {
                    ...
                    lab8:
                        z->c = z->l - v_8;
                        if (z->c <= z->lb || z->p[z->c - 1] != 0xE7) { z->c = z->l - v_7; goto lab6; }
                        z->c--;
                        z->bra = z->c;
                        {
